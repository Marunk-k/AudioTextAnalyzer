...
public class ProjectController {
 ...
 @GetMapping("/projects/{id}") public String details(@PathVariable Long id, Model m){ m.addAttribute("project",repo.findById(id).orElseThrow()); m.addAttribute("recognitionMode", smart.currentMode()); return "project-details"; }
