...
public class AppProperties {
    ...
    public static class Audio {
        ...
        public List<String> allowedExtensions = new ArrayList<>();
        public String getFfmpegPath(){return ffmpegPath;}
        public void setFfmpegPath(String v){ffmpegPath=v;}
        public String getFfprobePath(){return ffprobePath;}
        public void setFfprobePath(String v){ffprobePath=v;}
        public List<String> getAllowedExtensions(){return allowedExtensions;}
        public void setAllowedExtensions(List<String> v){allowedExtensions=v;}
    }
    ...
    public static class Storage { public String uploadDir="data/uploads"; public String convertedDir="data/converted"; public String exportDir="data/exports"; public String getUploadDir(){return uploadDir;} public void setUploadDir(String v){uploadDir=v;} public String getConvertedDir(){return convertedDir;} public void setConvertedDir(String v){convertedDir=v;} public String getExportDir(){return exportDir;} public void setExportDir(String v){exportDir=v;} }
