...
public class Project {
    private Long id; private Long userId; private String ownerLogin; private String title; private String originalFileName; private String originalFilePath; private String convertedFilePath;
    ...
    private Double durationSeconds = 0.0; private String rawText; private String processedText; private String aiText; private String manualText; private TextAnalysisResult analysisResult;
    private List<TranscriptionSegment> segments = new ArrayList<>();
    public Long getId(){return id;} public void setId(Long id){this.id=id;} public Long getUserId(){return userId;} public void setUserId(Long userId){this.userId=userId;} public String getOwnerLogin(){return ownerLogin;} public void setOwnerLogin(String ownerLogin){this.ownerLogin=ownerLogin;} public String getTitle(){return title;} public void setTitle(String title){this.title=title;}
    ...
    public String getRawText(){return rawText;} public void setRawText(String t){rawText=t;} public String getProcessedText(){return processedText;} public void setProcessedText(String t){processedText=t;} public String getAiText(){return aiText;} public void setAiText(String t){aiText=t;} public String getManualText(){return manualText;} public void setManualText(String manualText){this.manualText=manualText;}
