...
public class ProjectController {
 ...
 public ProjectController(ProjectRepository r, ProcessingService p, SmartTranscriptionService s, CurrentUserService currentUserService){repo=r;proc=p;smart=s;this.currentUserService=currentUserService;}
